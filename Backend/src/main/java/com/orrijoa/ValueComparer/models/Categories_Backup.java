...
public class Categories_Backup {
...
//        List<String> householdAndCleaningSuppliesSubCategory = Arrays.asList("Laundry detergent", "dish soap", "dishwashing liquid", "paper towels", "tissues", "trash bags", "aluminum fsList("Baby food", "diapers", "wet wipes", "lotion", "etc");oil", "zip bags", "etc");
//////        List<String> babyItemsSubCategory = Arrays.a
